...
<div class="fill">
            <center><p style="font-family: Javanese Text;"> Heyy there! <?php echo $name; ?><br><br>Let's take a minute and Rate our messy Mess!</p></center>
</div>

<div class="form">
    <center><p style="font-family: Javanese Text;">Select the avg you want to give, 1 being the lowest and 5 the highest!</p></center>
<form action="fb_ihmess.php" method="post">
...
<?php
    ...
    $sql_insert = "INSERT INTO fb_ihmess(usn, name, feedback) values('$usn', '$name', '$feedb');";
