...
<div class="fill">
            <center><p> Heyy there! <?php echo $name; ?><br><br>Let's take a minute and rate out messy mess!</p></center><br><br>
</div>
...
<?php
    ...
    $sql_insert = "INSERT INTO feedback(usn, feedback, name) values('$usn', '$feedb', '$name');";
