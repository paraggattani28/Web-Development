...
<style>
    ...
    body, html
    {
        background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ),url(images/blur-people-walking-2237190.jpg);
...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="contact"  align="center"><font face="Constantia" size="+3">Conatct : +91 8618754481</font><hr size="+1" color="white"></div>
...
echo '</tr>';
    ...
    $sql_extract = "SELECT * FROM nightcanteen;";
