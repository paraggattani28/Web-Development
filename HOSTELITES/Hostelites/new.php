...
<div class = "products">
    ...
    <center><p style="font-size: 30px; font-face: Courier New; margin-top:30px;">New Products</p><hr color="#b94c4c" size="0.5" width="400px" align="center" style="margin-bottom:50px;"></center>
    <form action="new_cart.php" method="post">
    <?php

        $sql_extract = "SELECT * FROM new;";
